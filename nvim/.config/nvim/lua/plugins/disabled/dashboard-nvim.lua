  ...
  opts = function()
    ...
    local opts = {
      ...
      config = {
        ...
        -- stylua: ignore
        center = {
          { action = 'lua LazyVim.pick()()',                           desc = " Buscar Archivo",       icon = " ", key = "f" },
          { action = "ene | startinsert",                              desc = " Nuevo Archivo",        icon = " ", key = "n" },
          { action = 'lua LazyVim.pick("oldfiles")()',                 desc = " Recientes",    icon = " ", key = "r" },
          { action = 'lua LazyVim.pick("live_grep")()',                desc = " Buscar Texto",       icon = " ", key = "g" },
          { action = 'lua LazyVim.pick.config_files()()',              desc = " Config",          icon = " ", key = "c" },
          { action = 'lua require("persistence").load()',              desc = " Sesiones", icon = " ", key = "s" },
