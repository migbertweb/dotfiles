...
return
  ...
  event = "VeryLazy",
keys = {
    { "<leader>r", "", desc = "+Remote-SSH" },
    { "<leader>ra", "<cmd>:RemoteStart<cr>", desc = "Iniciar Conexion SSH" },
    { "<leader>rs", "<cmd>:RemoteStop<cr>", desc = "Parar conexion SSH" },
    { "<leader>rc", "<cmd>:RemoteCleanup<cr>", desc = "Borrar Conexion SSH" },
  },
}
